// src/lib.rs
/*
 * Core library for ThreeJSRender
 */
...
#[derive(Debug)]
pub struct ThreeJSRenderProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ThreeJSRenderProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ThreeJSRender processing");
    
    let mut processor = ThreeJSRenderProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ThreeJSRenderProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ThreeJSRenderProcessor::new(false);
